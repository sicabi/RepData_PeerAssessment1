...
```{r load.data, echo = TRUE, results = "show"}
...
```{r process.data1, echo = TRUE, results = "show"}
str(activity.data)
```
...
```{r process.data2, echo = TRUE, results = "show"}
...
```{r process.data3, echo = TRUE, results = "show"}
str(activity.data)
```
...
```{r total.number.steps1, echo = TRUE, results = "show"}
...
```{r total.number.steps2, echo = TRUE, results = "hide"}
...
```{r total.number.steps3, echo = TRUE, results = "show"}
...
```{r total.number.steps4, echo = TRUE, results = "show"}
...
```{r daily.activity.pattern1, echo = TRUE, results = "show"}
...
```{r daily.activity.pattern2, echo = TRUE, results = "show"}
...
```{r daily.activity.pattern3, echo = TRUE, results = "show"}
...
```{r daily.activity.plot, echo = TRUE, results = "show"}
...
```{r maximun.steps.number, echo = TRUE, results = "show"}
...
```{r explore.missing2, echo TRUE, results = "show"}
...
```{r, explore.missing3, echo = TRUE, results = "show"}
...
```{r impute.missing, echo TRUE, results = "show"}
...
```{r new.data.set, echo = TRUE, results = "show"}
...
```{r check.data.set1, echo = TRUE, results = "show"}
str(activity.data)
```

While the new one has this structure:

```{r check.data.set2, echo = TRUE, results = "show"}
...
```{r new.steps.mean1, echo = TRUE, results = TRUE}
...
```{r new.steps.mean2, echo = TRUE, results = TRUE}
...
```{r weekdays.weekend1, echo = TRUE, results = "show"}
...
```{r weekdays.weekend2, echo = TRUE, results = "show"}
...
```{r weekdays.weekend3, echo = TRUE, results = "show"}
...
```{r weekdays.weekend4, echo = TRUE, results = "show"}
...
```{r weekdays.weekend, echo = TRUE, results = "show"}
...
```{r plot.weekdays.weekend, echo = TRUE, results = "show"}
library("lattice")
